        ...
        <div class="section-items">
            ...
            <div class="card-items">
                ...
                foreach ($benefitsCardItems as $benefitsCardItem) { ?>
                    <div class="card-item <?php echo $benefitsCardItem['delete-class']; ?>">
                        <div class="card-number">
                            <p class="fw-bold text-end"><?php echo $benefitsCardItem['number']; ?></p>
                        </div>
                        <div class="card-description">
                            <p class="fs-5 fw-semibold"><?php echo $benefitsCardItem['cardName']; ?></p>
                            <p class="small-size-p color-grey-one"><?php echo $benefitsCardItem['cardText']; ?></p>
                        </div>
                        <div class="section-btn">
                            <button type="button">
