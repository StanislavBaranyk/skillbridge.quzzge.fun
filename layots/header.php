    ...
    <div class="container">
        <div class="section-items">
            ...
            <nav class="header-nav">
                ...
                <ul class="nav-items">
                    <li class="nav-item">
                        <a  href="/sign-up-page.php" style="text-decoration: none"q class="transparent-btn" type="button">Sign Up</a>
                    </li>
                    <li class="nav-item">
                        <a href="/login-page.php" style="text-decoration: none" class="orange-btn" type="button">Login</a>
                    </li>
                    <li class="nav-item">
                        <svg id="show-nav" xmlns="http://www.w3.org/2000/svg" width="34" height="35" viewBox="0 0 34 35" fill="none">
                            <path fill-rule="evenodd" clip-rule="evenodd"
...
<div class="nav-container hide-nav" id="nav-container">
    <div class="container">
        <nav>
            <ul class="list-items">
                <?php
